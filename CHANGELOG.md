...
- Add `false_allow_templates` as an option for "dynamic" in schema which supports indexing on properties and dynamic_templates but ignores any fields that do not match either
